...
import 'package:trial15/pages/giftPageDetails.dart';
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => GiftDetailsPage(
          gift: gift,
          onSave: (updatedGift) {
            // Save updated gift logic
            setState(() {
              gifts[gifts.indexOf(gift)] = updatedGift;
            });
          },
        ),
      ),
    ...
    return Scaffold(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            leading: gift['image'] != null
                ? Image.file(gift['image'],
                    width: 50, height: 50, fit: BoxFit.cover)
                : Icon(Icons.card_giftcard),
            title: Text(
              gift['name'],
              style:
                  TextStyle(color: selectedIndex == index ? Colors.blue : null),
            ),
            ...
            onLongPress: () {
              setState(() {
                selectedIndex = index;
                selectedColor = Colors.blue; // Change color on long press
              });
            },
          );
        },
      ...
      floatingActionButton: Column(
        ...
        children: [
          ...
          FloatingActionButton(
            onPressed:
                selectedIndex != null && !gifts[selectedIndex!]['isPledged']
                    ? () => _showGiftDialog(
                        gift: gifts[selectedIndex!], index: selectedIndex)
                    : null,
            heroTag: 'edit',
            mini: true,
